...
module.exports = {
  checkForRedirects: (req, res, next) => {
    ...
    if (
      req.hostname.indexOf('restvo.com') == -1
    ) {
  ...
  loadLocalVars: async (req, res, next) => {
    ...
    res.setHeader('Link', '<https://site.restvo.com/assets/fonts/eina/eina-01-bold.woff2>;rel=preload;as=font;type=font/woff2;crossorigin=anonymous,<https://site.restvo.com/assets/fonts/inter/Inter-variable-ASCII-subset.woff2>;rel=preload;as=font;type=font/woff2;crossorigin=anonymous');
